package step1_01.print; // 1) 패키지 선언문은 '항상' 첫 줄에 작성한다.
...
* 		7-7) 왼쪽 카테고리가 지워지면 : 윈도우 -> perspective -> Reset perspective
*  
* */
...
public class PrintEx01 {
	...
	public static void main(String[] args) { // main메서드 {}안에서 프로그래밍을 한다.
		...
		//print를 적으려면 괄호안데 데이터를 넣어줘야한다. -> 화면에 내용을 출력 후 줄바꿈 x 
		//System.out.print();
