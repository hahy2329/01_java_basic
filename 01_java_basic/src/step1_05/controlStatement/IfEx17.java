...
public class IfEx17 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		else {  //위 조건식이 false일 때 실행 
			System.out.println("불합격");
		}
		
		System.out.println();
		
		finalScore = 95;   //if ~else if문은 하나의 조건식만 맞으면 다음 조건식을 더이상 보지 않고 끝
		if(finalScore >=90) {
			System.out.println("A");
		}
		else if(finalScore >=80) { // 위 조건식이 false이고, 해당 조건식 true일때 실행
			System.out.println("B");
		}
		else if(finalScore >=70) { // 위 조건식이 false이고, 해당 조건식 true일때 실행
